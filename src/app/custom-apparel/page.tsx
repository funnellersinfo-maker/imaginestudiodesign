...
function Services({ waLink }: { waLink: string }) {
  ...
  const text = lang === "es" ? {
    ...
    services: [
      ...
      { num: "03", title: "Gorras Personalizadas", desc: "Pon tu marca\n donde la gente la vea.", img: "/images/apparel/team-imagine.jpg", cta: "EXPLORAR" },
    ]
  } : {
    title: "WHAT WE MAKE",
    services: [
      ...
      { num: "03", title: "Custom Caps", desc: "Put your brand\nwhere people can see it.", img: "/images/apparel/team-imagine.jpg", cta: "EXPLORE" },
    ]
  };
    ...
    <section id="section-4" className="relative py-24 lg:py-40 overflow-hidden bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <Image src="/images/apparel/service-caps.jpg" alt="Imagine Studio Design team wearing matching branded apparel" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 50vw" />
          </motion.div>
        </div>
      </div>
    </section>
