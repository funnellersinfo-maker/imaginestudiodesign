...
const PB_BIZ_KEYS = [
  "pb.biz.contractor", "pb.biz.roofing", "pb.biz.hvac", "pb.biz.plumbing", "pb.biz.electrical",
  "pb.biz.landscaping", "pb.biz.painting", "pb.biz.tree", "pb.biz.concrete",
  "pb.biz.restaurant", "pb.biz.retail", "pb.biz.otherService", "pb.biz.other",
];

const PB_INDUSTRIES_DATA = [
  { icon: HardHat, labelKey: "pb.ind.contractors", descKey: "pb.ind.contractorsDesc" },
  { icon: HomeIcon, labelKey: "pb.ind.roofing", descKey: "pb.ind.roofingDesc" },
  { icon: Snowflake, labelKey: "pb.ind.hvac", descKey: "pb.ind.hvacDesc" },
  { icon: Wrench, labelKey: "pb.ind.plumbing", descKey: "pb.ind.plumbingDesc" },
  { icon: Plug, labelKey: "pb.ind.electrical", descKey: "pb.ind.electricalDesc" },
  { icon: TreePine, labelKey: "pb.ind.landscaping", descKey: "pb.ind.landscapingDesc" },
  { icon: PaintBucket, labelKey: "pb.ind.painting", descKey: "pb.ind.paintingDesc" },
  { icon: TreePine, labelKey: "pb.ind.tree", descKey: "pb.ind.treeDesc" },
  { icon: GlassWater, labelKey: "pb.ind.concrete", descKey: "pb.ind.concreteDesc" },
  { icon: Building2, labelKey: "pb.ind.construction", descKey: "pb.ind.constructionDesc" },
  { icon: Store, labelKey: "pb.ind.restaurant", descKey: "pb.ind.restaurantDesc" },
  { icon: Store, labelKey: "pb.ind.retail", descKey: "pb.ind.retailDesc" },
];

const PB_SIGN_TYPES_DATA = [
  { icon: Briefcase, titleKey: "pb.vis.cards", descKey: "pb.vis.cardsDesc" },
  { icon: Layers, titleKey: "pb.vis.flyers", descKey: "pb.vis.flyersDesc" },
  { icon: Store, titleKey: "pb.vis.banners", descKey: "pb.vis.bannersDesc" },
  { icon: Users, titleKey: "pb.vis.apparel", descKey: "pb.vis.apparelDesc" },
  { icon: Palette, titleKey: "pb.vis.identity", descKey: "pb.vis.identityDesc" },
  { icon: Sparkles, titleKey: "pb.vis.stickers", descKey: "pb.vis.stickersDesc" },
];

const PB_PROCESS_DATA = [
  { num: "01", titleKey: "pb.process.step1", descKey: "pb.process.step1Desc", icon: Phone },
  { num: "02", titleKey: "pb.process.step2", descKey: "pb.process.step2Desc", icon: Palette },
  { num: "03", titleKey: "pb.process.step3", descKey: "pb.process.step3Desc", icon: Layers },
  { num: "04", titleKey: "pb.process.step4", descKey: "pb.process.step4Desc", icon: Truck },
  { num: "05", titleKey: "pb.process.step5", descKey: "pb.process.step5Desc", icon: Eye },
];

const PB_METRICS_DATA = [
  { value: "1500+", labelKey: "pb.trust.projects" },
  { value: "98%", labelKey: "pb.trust.satisfaction" },
  { value: "10+", labelKey: "pb.trust.experience" },
  { value: "24h", labelKey: "pb.trust.turnaround" },
];
...
const PB_FAQ_KEYS = [
  { qKey: "pb.faq.q1", aKey: "pb.faq.a1" },
  { qKey: "pb.faq.q2", aKey: "pb.faq.a2" },
  { qKey: "pb.faq.q3", aKey: "pb.faq.a3" },
  { qKey: "pb.faq.q4", aKey: "pb.faq.a4" },
  { qKey: "pb.faq.q5", aKey: "pb.faq.a5" },
];
...
/* ═══════════════════════════════════════════════════
   NAV — reused, adapted nav links for Printing & Branding
   ═══════════════════════════════════════════════════ */
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            <a href="#our-work" className="text-sm lg:text-base text-gray-400 hover:text-white transition-colors">{t("pb.nav.transformations")}</a>
            <a href="#sign-types" className="text-sm lg:text-base text-gray-400 hover:text-white transition-colors">{t("pb.nav.services")}</a>
            <a href="#portfolio" className="text-sm lg:text-base text-gray-400 hover:text-white transition-colors">{t("pb.nav.projects")}</a>
            <a href="#process" className="text-sm lg:text-base text-gray-400 hover:text-white transition-colors">{t("pb.nav.process")}</a>
          </div>
          <div className="hidden md:flex items-center gap-3 lg:gap-4">
            ...
            <button onClick={onQuote} className="cta-primary text-white text-sm font-bold px-6 py-2.5 rounded-lg tracking-wide">{t("pb.nav.getQuote")}</button>
          </div>
        ...
        {open && (
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} className="md:hidden pb-6 pt-2 border-t border-white/5">
            <div className="flex flex-col gap-4">
              <a href="#our-work" onClick={() => setOpen(false)} className="text-gray-300 hover:text-white py-2">{t("pb.nav.transformations")}</a>
              <a href="#sign-types" onClick={() => setOpen(false)} className="text-gray-300 hover:text-white py-2">{t("pb.nav.services")}</a>
              <a href="#portfolio" onClick={() => setOpen(false)} className="text-gray-300 hover:text-white py-2">{t("pb.nav.projects")}</a>
              <a href="#process" onClick={() => setOpen(false)} className="text-gray-300 hover:text-white py-2">{t("pb.nav.process")}</a>
              ...
              <button onClick={() => { setOpen(false); onQuote(); }} className="cta-primary text-white font-bold py-3 rounded-xl text-sm tracking-wide w-full">{t("pb.nav.getFreeQuote")}</button>
            </div>
          </motion.div>
        )}
      </div>
...
/* ═══════════════════════════════════════════════════
   1. HERO — adapted for Printing & Branding
   ═══════════════════════════════════════════════════ */
function HeroSection({ onQuote }: { onQuote: () => void }) {
  ...
  const waLink = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
    lang === "es"
      ...
      : `Hi! I'd like a quote for printing & branding.\n1. Name: ${form.name || "..."}\n2. Business: ${form.businessType || "..."}\n3. Message: ${form.message || "..."}`
  )}`;

  const isFormValid = form.name.trim() !== "" && form.businessType !== "" && form.message.trim() !== "";

  const headlines = [
    { line1: t("pb.hero.h1.line1"), line2: t("pb.hero.h1.line2"), line3: t("pb.hero.h1.line3") },
    { line1: t("pb.hero.h2.line1"), line2: t("pb.hero.h2.line2"), line3: t("pb.hero.h2.line3") },
    { line1: t("pb.hero.h3.line1"), line2: t("pb.hero.h3.line2"), line3: t("pb.hero.h3.line3") },
  ];
      ...
      <div className="relative z-10 w-full max-w-5xl lg:max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-32 md:pt-40 lg:pt-48 pb-20 md:pb-20 lg:pb-28">
        ...
        <FadeUp delay={0.1}>
          <div className="inline-flex items-center gap-1.5 px-2.5 sm:px-4 py-1 sm:py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm mt-10 sm:mt-0 mb-8 lg:mb-24">
            ...
            <span className="text-[9px] sm:text-sm text-gray-300 text-center leading-tight whitespace-nowrap">{t("pb.hero.badge")}</span>
          </div>
        </FadeUp>
            ...
            <div className="shimmer-border rounded-2xl">
              <div className="shimmer-inner-dark rounded-[14px]">
                <div className="relative aspect-[4/3] sm:aspect-[16/10] lg:aspect-video rounded-[14px] overflow-hidden bg-white/5">
                  <Image src={PB_HERO_STATIC_IMAGE} alt="Custom business sign installation by Imagine Studio Design in Wilmington NC" fill priority className="object-cover" sizes="(max-width: 700px) 100vw, 700px" />
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Subtitle */}
        <FadeUp delay={0.35}>
          <p className="text-[0.9rem] sm:text-lg md:text-xl lg:text-xl text-gray-300 max-w-2xl lg:max-w-3xl mx-auto mb-8 lg:mb-12 leading-relaxed drop-shadow-md">{t("pb.hero.subtitle")}</p>
        </FadeUp>
              ...
              <div className="shimmer-inner-dark rounded-[14px] p-4 sm:p-6">
                ...
                <div className="relative mb-3">
                  ...
                  <Input
                    ...
                    placeholder={t("pb.hero.form.name")}
                ...
                <div className="relative mb-3">
                  ...
                  <Select value={form.businessType} onValueChange={(v) => { setForm((f) => ({ ...f, businessType: v })); }}>
                    <SelectTrigger className="pl-10 bg-white/5 text-white rounded-xl h-11 text-sm border-white/10 focus:border-brand-hot-pink/50">
                      <SelectValue placeholder={t("pb.hero.form.business")} />
                    </SelectTrigger>
                ...
                <div className="relative mb-4">
                  ...
                  <Textarea
                    ...
                    placeholder={t("pb.hero.form.message")}
                ...
                <a
                  ...
                  onClick={(e) => {
                    ...
                    try { (window as any).fbq("track", "Lead", { content_name: "Printing & Branding Hero Mini Form" }); } catch {}
                  }}
            ...
            <div className="shimmer-border-glow rounded-2xl">
              <div className="shimmer-inner-dark rounded-[14px]">
                <div className="relative aspect-[16/9] rounded-[14px] overflow-hidden bg-white/5">
                  <Image src={PB_SHOWCASE_IMAGE} alt="Imagine Studio Design printing & branding showcase — exterior signs, channel letters, monument signs and more" fill loading="lazy" className="object-cover" sizes="(max-width: 700px) 100vw, 700px" />
                </div>
              </div>
            </div>
            <p className="text-center text-sm sm:text-base font-bold gradient-brand-text mt-4 leading-snug drop-shadow-md">
              {t("pb.hero.showcase.tagline")}
            </p>
          </div>
        </FadeUp>
          ...
          <div className="mt-8 sm:mt-14 lg:mt-20 w-full max-w-xl lg:max-w-3xl mx-auto">
            ...
            <div className="mt-4 pt-4 sm:mt-8 sm:pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-center gap-3 lg:gap-14">
              <div className="flex items-center gap-1.5 sm:gap-2">
                ...
                <span className="text-xs sm:text-sm lg:text-base text-gray-400">{t("pb.hero.trust5Stars")}</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                <span className="text-base sm:text-lg lg:text-2xl font-black gradient-brand-text">{t("pb.hero.trustProjects")}</span>
                <span className="text-xs sm:text-sm lg:text-base text-gray-400">{t("pb.hero.trustProjectsLabel")}</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                <span className="text-base sm:text-lg lg:text-2xl font-black gradient-brand-text">{t("pb.hero.trustYears")}</span>
                <span className="text-xs sm:text-sm lg:text-base text-gray-400">{t("pb.hero.trustYearsLabel")}</span>
              </div>
            </div>
          </div>
        </FadeUp>
...
/* ═══════════════════════════════════════════════════
   3. PROBLEM — adapted for Printing & Branding
   ═══════════════════════════════════════════════════ */
function ProblemSection() {
  const { t } = useLang();
  const pains = [t("pb.problem.pain1"), t("pb.problem.pain2"), t("pb.problem.pain3")];
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeUp>
          <div className="text-center mb-16 lg:mb-20">
            <span className="inline-block text-sm font-semibold tracking-widest uppercase text-brand-hot-pink mb-4">{t("pb.problem.tag")}</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 lg:mb-8 leading-tight">
              {t("pb.problem.title1")} <span className="gradient-brand-text">{t("pb.problem.titleHighlight")}</span>.
            </h2>
            <p className="text-gray-400 text-lg lg:text-xl max-w-2xl lg:max-w-3xl mx-auto">{t("pb.problem.subtitle")}</p>
          </div>
        </FadeUp>
        ...
        <FadeUp delay={0.4}>
          <div className="mt-12 text-center">
            <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-2">{t("pb.problem.soundFamiliar")}</p>
            <p className="text-gray-400 text-base lg:text-lg">{t("pb.problem.goodNews")} <span className="text-brand-bright-blue font-semibold">{t("pb.problem.fixable")}</span></p>
          </div>
        </FadeUp>
      </div>
    </section>
...
/* ═══════════════════════════════════════════════════
   4. TRANSFORMATION — adapted for Printing & Branding
   ═══════════════════════════════════════════════════ */
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeUp>
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            <span className="inline-block text-sm font-semibold tracking-widest uppercase text-brand-hot-pink mb-4">{t("pb.transform.tag")}</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 lg:mb-8 leading-tight">
              {t("pb.transform.from")} <span className="text-gray-500">{t("pb.transform.invisible")}</span> {t("pb.transform.to")} <span className="gradient-brand-text">{t("pb.transform.impossible")}</span>
            </h2>
            <p className="text-gray-400 text-base sm:text-lg lg:text-xl max-w-2xl lg:max-w-3xl mx-auto">{t("pb.transform.subtitle")}</p>
          </div>
        </FadeUp>
        <ScaleIn delay={0.1}>
          <div className="mb-10">
            ...
            />
            <p className="text-center text-sm text-gray-500 mt-4">{t("pb.transform.realProject")}</p>
          </div>
        </ScaleIn>
...
/* ═══════════════════════════════════════════════════
   5. WHO WE HELP — adapted for Printing & Branding
   ═══════════════════════════════════════════════════ */
  ...
  return (
    <section className="relative py-20 md:py-28 lg:py-36 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeUp>
          <div className="text-center mb-16 lg:mb-20">
            <span className="inline-block text-sm font-semibold tracking-widest uppercase text-brand-hot-pink mb-4">{t("pb.who.tag")}</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 lg:mb-8 leading-tight">
              {t("pb.who.title1")} <span className="gradient-brand-text">{t("pb.who.titleHighlight")}</span>
            </h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">{t("pb.who.subtitle")}</p>
          </div>
        </FadeUp>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-6">
          {PB_INDUSTRIES_DATA.map((ind, i) => (
        ...
        <FadeUp delay={0.5}>
          <div className="mt-12 text-center">
            <p className="text-gray-400 mb-4"><Store className="w-4 h-4 inline mr-1" /> {t("pb.who.also")}</p>
            <button onClick={onQuote} className="cta-primary text-white font-bold px-8 py-3.5 rounded-xl text-sm tracking-wide inline-flex items-center gap-2">
              {t("pb.who.seeCta")} <ArrowRight className="w-4 h-4" />
            </button>
          </div>
        </FadeUp>
      </div>
...
/* ═══════════════════════════════════════════════════
   6. SIGN TYPES (Visibility System) — adapted for Printing & Branding
   ═══════════════════════════════════════════════════ */
  ...
  return (
    <section id="sign-types" className="relative py-20 md:py-28 lg:py-36 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeUp>
          <div className="text-center mb-16 lg:mb-20">
            <span className="inline-block text-sm font-semibold tracking-widest uppercase text-brand-hot-pink mb-4">{t("pb.vis.tag")}</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 lg:mb-8 leading-tight">
              {t("pb.vis.title1")} <span className="gradient-brand-text">{t("pb.vis.titleHighlight")}</span>
            </h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">{t("pb.vis.subtitle")}</p>
          </div>
        </FadeUp>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {PB_SIGN_TYPES_DATA.map((item, i) => (
        ...
        <FadeUp delay={0.5}>
          <div className="mt-12 p-6 rounded-2xl border border-brand-purple/20 bg-brand-purple/5 text-center">
            <p className="text-white text-lg font-semibold mb-2">{t("pb.vis.everything")} <span className="gradient-brand-text">{t("pb.vis.professional")}</span>.</p>
            <button onClick={onQuote} className="mt-4 cta-primary text-white font-bold px-8 py-3.5 rounded-xl text-sm tracking-wide inline-flex items-center gap-2">
              {t("pb.vis.customCta")} <ArrowRight className="w-4 h-4" />
            </button>
          </div>
        </FadeUp>
      </div>
...
/* ═══════════════════════════════════════════════════
   7. FEATURED PROJECTS — adapted for Printing & Branding
   ═══════════════════════════════════════════════════ */
        ...
        <FadeUp>
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-white mb-4 lg:mb-6 leading-tight">
              {t("pb.featured.headline")}
            </h2>
            <p className="text-sm sm:text-base text-gray-500 max-w-xl mx-auto">{t("pb.featured.subline")}</p>
          </div>
        </FadeUp>
        <FadeIn delay={0.2}>
          <div className="relative pl-12 pr-12 lg:pl-16 lg:pr-16">
            <Carousel opts={{ align: "start", loop: true }} className="w-full">
              <CarouselContent className="-ml-4">
                {PB_PROJECTS_DATA.map((project, i) => (
...
/* ═══════════════════════════════════════════════════
   8. TRUST — adapted for Printing & Branding
   ═══════════════════════════════════════════════════ */
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <FadeUp delay={0.2}>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6 mb-16 lg:mb-20">
            ...
            <div className="flex items-center justify-center gap-2 p-4 rounded-xl border border-white/5 bg-white/[0.02]">
              ...
              <span className="text-gray-300 text-sm lg:text-base font-medium">{t("pb.trust.projects")}</span>
            </div>
            <div className="flex items-center justify-center gap-2 p-4 rounded-xl border border-white/5 bg-white/[0.02]">
              <span className="text-xl lg:text-2xl font-black gradient-brand-text">10+</span>
              <span className="text-gray-300 text-sm lg:text-base font-medium">{t("pb.trust.experience")}</span>
            </div>
            <div className="flex items-center justify-center gap-2 p-4 rounded-xl border border-white/5 bg-white/[0.02]">
              <span className="text-xl lg:text-2xl font-black gradient-brand-text">98%</span>
              <span className="text-gray-300 text-sm lg:text-base font-medium">{t("pb.trust.satisfaction")}</span>
            </div>
          </div>
        </FadeUp>
        {/* Guarantee */}
        <FadeUp delay={0.3}>
          <div className="text-center">
            <p className="text-gray-400 text-sm"><Shield className="w-4 h-4 inline mr-1 text-brand-purple" /> {t("pb.trust.guarantee")}</p>
          </div>
        </FadeUp>
      </div>
    </section>
...
/* ═══════════════════════════════════════════════════
   8.5. FAQ — NEW section for Printing & Branding
   ═══════════════════════════════════════════════════ */
function FAQSection() {
  const { t } = useLang();
  return (
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeUp>
          <div className="text-center mb-12 lg:mb-16">
            <span className="inline-block text-sm font-semibold tracking-widest uppercase text-brand-hot-pink mb-4">{t("pb.faq.tag")}</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 lg:mb-8 leading-tight">
              {t("pb.faq.title1")} <span className="gradient-brand-text">{t("pb.faq.titleHighlight")}</span>
            </h2>
          </div>
        </FadeUp>
        <FadeUp delay={0.2}>
          <Accordion type="single" collapsible className="space-y-4">
            {PB_FAQ_KEYS.map((faq, i) => (
...
/* ═══════════════════════════════════════════════════
   9. PROCESS — adapted for Printing & Branding
   ═══════════════════════════════════════════════════ */
  ...
  return (
    <section id="process" className="relative py-20 md:py-28 lg:py-36 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeUp>
          <div className="text-center mb-16 lg:mb-20">
            <span className="inline-block text-sm font-semibold tracking-widest uppercase text-brand-hot-pink mb-4">{t("pb.process.tag")}</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 lg:mb-8 leading-tight">
              {t("pb.process.title1")} <span className="gradient-brand-text">{t("pb.process.titleHighlight")}</span>.
            </h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">{t("pb.process.subtitle")}</p>
          </div>
        </FadeUp>
        ...
        <FadeUp delay={0.5}>
          <div className="mt-12 text-center">
            <button onClick={onQuote} className="cta-primary text-white font-bold px-8 py-3.5 rounded-xl text-sm tracking-wide inline-flex items-center gap-2">
              {t("pb.process.cta")} <ArrowRight className="w-4 h-4" />
            </button>
          </div>
        </FadeUp>
      </div>
...
/* ═══════════════════════════════════════════════════
   10. FINAL CTA — adapted for Printing & Branding
   ═══════════════════════════════════════════════════ */
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <FadeUp delay={0.1}>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white mb-6 lg:mb-8 leading-tight">
            {t("pb.final.title1")} <span className="gradient-brand-text">{t("pb.final.titleHighlight")}</span> {t("pb.final.title2")}
          </h2>
        </FadeUp>
        <FadeUp delay={0.2}>
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-400 max-w-2xl lg:max-w-3xl mx-auto mb-4 lg:mb-6 leading-relaxed">{t("pb.final.subtitle")}</p>
        </FadeUp>
        <FadeUp delay={0.3}>
          <p className="text-white text-xl lg:text-2xl font-bold mb-10 lg:mb-14">{t("pb.final.build")} <span className="gradient-brand-text">{t("pb.final.unstoppable")}</span>.</p>
        </FadeUp>
        <FadeUp delay={0.4}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 lg:gap-6 mb-8">
            <button onClick={onQuote} className="cta-primary text-white font-bold px-10 lg:px-12 py-4 lg:py-5 rounded-xl text-lg lg:text-xl tracking-wide flex items-center gap-2 min-w-[280px] lg:min-w-[320px] justify-center animate-pulse-glow">
              {t("pb.final.cta")} <ArrowRight className="w-5 h-5" />
            </button>
        ...
        <FadeUp delay={0.5}>
          <div className="flex flex-wrap items-center justify-center gap-4 lg:gap-6 text-gray-500 text-sm lg:text-base">
            <span className="flex items-center gap-1"><Clock className="w-4 h-4" /> {t("pb.final.fast")}</span>
            <span className="text-white/10">|</span>
            <span className="flex items-center gap-1"><Shield className="w-4 h-4" /> {t("pb.final.quality")}</span>
            <span className="text-white/10">|</span>
            <span className="flex items-center gap-1"><MapPin className="w-4 h-4" /> {t("pb.final.wilmington")}</span>
          </div>
        </FadeUp>
      </div>
    </section>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeUp>
          <div className="text-center mb-10 lg:mb-14">
            <span className="inline-block text-sm font-semibold tracking-widest uppercase text-brand-hot-pink mb-4">{t("pb.map.tag")}</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-6 leading-tight">{t("pb.map.title")}</h2>
            <p className="text-gray-400 text-base lg:text-lg max-w-2xl mx-auto">{t("pb.map.subtitle")}</p>
          </div>
        </FadeUp>
        <FadeUp delay={0.1}>
          <div className="glass rounded-2xl p-6 lg:p-8 mb-8 max-w-2xl mx-auto">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-white font-bold text-lg mb-1">{t("pb.map.addressLabel")}</h3>
...
/* ═══════════════════════════════════════════════════
   FOOTER — reused, adapted for Printing & Branding
   ═══════════════════════════════════════════════════ */
function Footer() {
  const { t } = useLang();
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-sm text-gray-500">
            ...
            <span className="flex items-center gap-1"><MapPin className="w-3 h-3" /> {t("pb.footer.location")}</span>
          </div>
        </div>
        <div className="mt-6 pt-6 border-t border-white/5 text-center text-xs text-gray-600">
          © {new Date().getFullYear()} {t("pb.footer.rights")}
        </div>
      </div>
    </footer>
  );
...
/* ═══════════════════════════════════════════════════
   MAIN PAGE — Printing & Branding Landing
   ═══════════════════════════════════════════════════ */
